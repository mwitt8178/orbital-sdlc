...
// ---------------------------------------------------------------------------
export const boardSchemas = pgTable('board_schemas', {
...
// ---------------------------------------------------------------------------
export const boardMappings = pgTable('board_mappings', {
    ...
    projectBoardUq: uniqueIndex('board_mappings_project_board_uq').on(t.projectId, t.boardId),
