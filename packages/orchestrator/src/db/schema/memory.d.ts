 ...
 */
export declare const projectMemoryEntries: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "project_memory_entries";
    schema: undefined;
    columns: {
        entryId: import("drizzle-orm/pg-core").PgColumn<{
            name: "entry_id";
            tableName: "project_memory_entries";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
...
export declare const projectMemoryTags: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "project_memory_tags";
    schema: undefined;
    columns: {
        entryId: import("drizzle-orm/pg-core").PgColumn<{
            name: "entry_id";
            tableName: "project_memory_tags";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
...
export declare const projectMemoryLinks: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "project_memory_links";
    schema: undefined;
    columns: {
        linkId: import("drizzle-orm/pg-core").PgColumn<{
            name: "link_id";
            tableName: "project_memory_links";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
        ...
        linkKind: import("drizzle-orm/pg-core").PgColumn<{
            name: "link_kind";
            tableName: "project_memory_links";
            dataType: "string";
            columnType: "PgText";
