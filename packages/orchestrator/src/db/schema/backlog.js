...
export const SPRINT_PRIORITY_CLASS = ['critical', 'standard', 'background'];
 ...
 * context.
 */
export const storyAcceptanceCriteria = pgTable('story_acceptance_criteria', {
...
export const sprints = pgTable('sprints', {
    ...
    pauseState: jsonb('pause_state').$type(),
    createdAt: timestamp('created_at', { withTimezone: true, mode: 'date' })
        .notNull()
        .defaultNow(),
    updatedAt: timestamp('updated_at', { withTimezone: true, mode: 'date' })
...
export const sprintCommitments = pgTable('sprint_commitments', {
    ...
    selectedStoryIds: jsonb('selected_story_ids').$type().notNull(),
 ...
 */
export const mondaySyncState = pgTable('monday_sync_state', {
    ...
    lastSeenItemIds: jsonb('last_seen_item_ids').$type().notNull().default([]),
