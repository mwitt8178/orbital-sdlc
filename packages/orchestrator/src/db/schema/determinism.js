 ...
 */
import { pgTable, uuid, text, jsonb, timestamp, integer, boolean, index, uniqueIndex, } from 'drizzle-orm/pg-core';
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
export const hookVersions = pgTable('hook_versions', {
    ...
    applies_to_event_types: jsonb('applies_to_event_types').$type().notNull(),
...
// ---------------------------------------------------------------------------
export const hookInvocations = pgTable('hook_invocations', {
