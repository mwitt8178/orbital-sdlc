 ...
 * float drift.
 */
import { pgTable, uuid, text, jsonb, integer, boolean, timestamp, bigint, index, uniqueIndex, } from 'drizzle-orm/pg-core';
// ---------------------------------------------------------------------------
// routing_decisions
// ---------------------------------------------------------------------------
...
// cost_accounting
// ---------------------------------------------------------------------------
export const costAccounting = pgTable('cost_accounting', {
    ...
    sessionTurnUnique: uniqueIndex('cost_accounting_session_turn_unique').on(t.sessionId, t.turnIndex),
}));
// ---------------------------------------------------------------------------
// routing_policies
// ---------------------------------------------------------------------------
...
export const providerHealth = pgTable('provider_health', {
    ...
    circuitState: text('circuit_state').notNull().default('closed').$type(),
...
export const routingRules = pgTable('routing_rules', {
    ...
    estimate: text('estimate').notNull().$type(),
