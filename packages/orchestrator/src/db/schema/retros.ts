...
export const PROPOSAL_CHANGE_TYPE = ['create', 'modify', 'delete'] as const
export type ProposalChangeType = (typeof PROPOSAL_CHANGE_TYPE)[number]

export const VERSION_DIFF_CHANGE_TYPE = ['added', 'modified', 'deleted'] as const
export type VersionDiffChangeType = (typeof VERSION_DIFF_CHANGE_TYPE)[number]

export const EXPECTED_DIRECTION = ['increase', 'decrease'] as const
...
export const retroReports = pgTable(
  'retro_reports',
  {
...
export const retroAnalyses = pgTable(
  'retro_analyses',
  {
...
export const retroProposals = pgTable(
  'retro_proposals',
  {
    ...
    expectedImpactCi: jsonb('expected_impact_ci').$type<{ low: number; high: number } | null>(),
    rollbackPath: text('rollback_path').notNull(),
    evidenceRefs: jsonb('evidence_refs')
      .$type<Array<{ event_id: string; aggregate_id?: string; summary: string }>>()
      .notNull()
      .default([]),
...
export const retroProposalLayers = pgTable(
  'retro_proposal_layers',
  {
...
export const systemVersionDiffs = pgTable(
  'system_version_diffs',
  {
    ...
    retroProposalId: uuid('retro_proposal_id').references(
      () => retroProposals.retroProposalId,
    ),
...
export const retroOutcomes = pgTable(
  'retro_outcomes',
  {
