 ...
 */
import { uuid, text, jsonb, timestamp, integer, bigint, index, } from 'drizzle-orm/pg-core';
...
// audit_exports
// ---------------------------------------------------------------------------
export const auditExports = audit.table('audit_exports', {
...
// audit_export_chunks
// ---------------------------------------------------------------------------
export const auditExportChunks = audit.table('audit_export_chunks', {
