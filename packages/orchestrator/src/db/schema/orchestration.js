 ...
 */
import { pgTable, uuid, text, integer, jsonb, boolean, bigint, timestamp, primaryKey, index, uniqueIndex, } from 'drizzle-orm/pg-core';
...
export const tasks = pgTable('tasks', {
    ...
    acceptanceCriteria: jsonb('acceptance_criteria').$type().notNull().default([]),
...
export const retryAttempts = pgTable('retry_attempts', {
    ...
    routingAdjustment: jsonb('routing_adjustment').$type(),
