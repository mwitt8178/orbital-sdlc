 ...
 */
export function setKnownAnthropicKeyPrefix(prefix) {
...
export function resetSanitizerState() {
    knownAnthropicPrefix = null;
}
// ---------------------------------------------------------------------------
// Error type
...
export class LocalDataLeakError extends Error {
    ...
    reason;
    procedure;
    constructor(path, reason, procedure = null) {
        super(`LOCAL_DATA_LEAK: rejected hub request — ${reason} at path '${path}'` +
 ...
 */
export function sanitizeForHub(body, procedure = null) {
    walk(body, '', procedure);
}
// ---------------------------------------------------------------------------
// Walker
// ---------------------------------------------------------------------------
function walk(node, path, procedure) {
...
function checkFieldName(key, path, procedure) {
...
function checkStringValue(value, path, procedure) {
 ...
 */
function emitLeakAlert(path, reason, procedure, fieldName) {
    logger.fatal({
