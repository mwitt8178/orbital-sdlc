...
export declare const GITHUB_ERROR_CODES: {
    ...
    readonly INTEGRATION_GITHUB_DOWN: "INTEGRATION_GITHUB_DOWN";
    /** Github 401 / 403 with auth issue (token invalid or scopes missing). */
    readonly INTEGRATION_GITHUB_AUTH: "INTEGRATION_GITHUB_AUTH";
    /** Github primary or secondary rate limit hit. */
    readonly RATE_LIMIT_GITHUB_API: "RATE_LIMIT_GITHUB_API";
    ...
    readonly NOT_FOUND_GITHUB: "NOT_FOUND_GITHUB";
