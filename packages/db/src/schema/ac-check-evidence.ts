...
export const AC_EVIDENCE_RESULT = ['pass', 'fail', 'ambiguous'] as const
...
export const acCheckEvidence = audit.table(
  'ac_check_evidence',
  {
    ...
    filesInspected: jsonb('files_inspected').$type<string[]>().notNull().default([]),
