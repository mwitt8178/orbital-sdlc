...
export const visionDocuments = pgTable(
  'vision_documents',
  {
...
export const visionVersions = pgTable(
  'vision_versions',
  {
...
export const visionQuestions = pgTable(
  'vision_questions',
  {
...
export const visionAnswers = pgTable(
  'vision_answers',
  {
...
export const visionAssumptions = pgTable(
  'vision_assumptions',
  {
