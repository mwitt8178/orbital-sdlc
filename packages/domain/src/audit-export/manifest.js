 ...
 */
export const DEFAULT_SOC2_CONTROL_MAPPING = {
    schema_version: 1,
    controls: [
        {
            control_id: 'CC6.1',
    ...
    notes: 'Every event_type emitted by Orbital maps to at least one SOC2 control in this table. ' +
 ...
 */
export const EVENT_TYPE_CONTROL_MAP = {
    // TRD-01: Events
    ...
    build(input) {
        ...
        const manifest = {
            ...
            cutoff: {
                ...
                explanation: 'This package contains all events with event_id <= cutoff_event_id. ' +
