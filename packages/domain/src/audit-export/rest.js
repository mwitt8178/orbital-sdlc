 ...
 */
export function registerAuditExportRoutes(app, _opts = {}) {
    /**
     * GET /api/v1/audit/export/:exportId
     ...
     */
    app.get('/api/v1/audit/export/:exportId', async (req, reply) => {
        ...
        void reply.header('Content-Disposition', `attachment; filename="${pkg.filename}"`);
