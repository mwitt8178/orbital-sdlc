...
export const midSprintDeviationRule = {
    id: RULE_ID,
    description: 'Schedule async standup when an active sprint has consumed >50% wallclock with <30% tasks done',
    ...
    async match(envelope, ctx) {
        ...
        if (!(elapsedPct > 50 && completedPct < 30))
            return null;
...
//# sourceMappingURL=mid-sprint-deviation.js.map