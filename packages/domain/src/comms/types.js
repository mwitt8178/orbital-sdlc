...
import { CHANNEL_KIND, CHANNEL_POST_TYPE, MENTION_TARGET_TYPE, CROSS_REF_TYPE, CROSS_POST_ARTIFACT_TYPE, REACTION_TYPE, } from '@orbital/db';
import { BLOCKER_URGENCY, CEREMONY_TYPE, CEREMONY_PARTICIPANT_ROLE, CEREMONY_VOTE, CEREMONY_VOTE_RULE, CEREMONY_OUTPUT_KIND, DISAGREEMENT_DOMAIN, } from '@orbital/db';
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
export const POST_TYPE_SCHEMAS = {
 ...
 */
export function validatePostPayload(postType, payload) {
 ...
 */
export function parseCrossReferences(body) {
    const refs = [];
    let match;
