 ...
 */
export declare function registerMondayReconciliation(opts: RegisterMondayReconciliationOptions): ReconciliationHandle;
//# sourceMappingURL=reconcile-bootstrap.d.ts.map