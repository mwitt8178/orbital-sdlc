 ...
 */
export type { EventEnvelope, EventInput, EventQueryFilter, AggregateType, Actor, } from '@orbital/types';
...
import type { EventRow } from '@orbital/db';
/**
 ...
 */
export declare function rowToEnvelope(row: EventRow): EventEnvelope;
/**
 ...
 */
export declare function encodeCursor(occurredAt: string, eventId: string): string;
 ...
 */
export declare function decodeCursor(cursor: string | null | undefined): DecodedCursor | null;
